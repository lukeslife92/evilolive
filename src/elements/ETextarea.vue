...
<docs>
  ```jsx
  <div>
    <ETextarea label="Default textarea" placeholder="Write your text" id="textarea-1" />
    <ETextarea label=":focus" state="focus" placeholder="Write your text" id="textarea-2" />
    <ETextarea label="[disabled]" disabled value="Write your text" id="textarea-3" />
  </div>
  ```
</docs>
