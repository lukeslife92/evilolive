...
<docs>
  ```jsx
  <div>
    <ETextStyle variation="default">Design isn’t just about the look and feel.</ETextStyle>
    <br />
    <ETextStyle variation="disabled">Design isn’t just about</ETextStyle>
    <br />
    <ETextStyle variation="strong">Design isn’t</ETextStyle>
  </div>
  ```
</docs>
