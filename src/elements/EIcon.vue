...
<docs>
  ```jsx
  <div>
    <EIcon name="ready" aria-label="Component is ready" fill="#7cb518" />
    <EIcon name="review" fill="rgb(255,186,10)" />
    <EIcon name="deprecated" fill="rgb(235,59,36)" />
    <EIcon name="prototype" fill="rgb(37,138,239)" />
  </div>
  ```
</docs>
