...
<docs>
  ```jsx
  <div>
    <EInput label="Default input" placeholder="Write your text" id="input-1" />
    <EInput label=":hover" state="hover" placeholder="Write your text" id="input-2" />
    <EInput label=":focus" state="focus" placeholder="Write your text" id="input-3" />
    <EInput label="[disabled]" disabled value="Write your text" id="input-4" />
  </div>
  ```
</docs>
