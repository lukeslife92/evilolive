          ...
          <td v-if="token.value">
            ...
            <div
              ...
              :style="{
                ...
                backgroundColor: cTokens.colorBleuDeFranceLight,
              }"
            />
            <div
            ...
            />
            <div
              v-if="token.category === 'font'"
              class="example font"
              :style="{
                fontFamily: token.value,
                fontWeight: token.value,
                fontSize: cTokens.sizeM,
                color: cTokens.colorCloud,
                backgroundColor: cTokens.colorOxfordBlue,
              }"
            >
              Font Example...
            </div>
            <div
              v-if="token.category === 'font-size'"
              class="example font"
              :style="{
            ...
            <div
              v-if="token.category === 'letter-spacing'"
              class="example font"
              :style="{
                letterSpacing: token.value,
                fontSize: cTokens.sizeM,
                fontWeight: cTokens.weightLight,
                color: cTokens.colorCloud,
                backgroundColor: cTokens.colorOxfordBlue,
              }"
            >
            ...
            <div
              v-if="token.category === 'line-height'"
              class="example font"
              :style="{
            ...
            >
              Font Example... <br />Font Example...
            </div>
            <div
              v-if="token.category === 'space'"
              class="example space"
              :style="{
                height: token.value,
                width: token.value,
                backgroundColor: cTokens.colorVermilionLight,
              }"
            />
            <div
              v-if="token.category === 'size'"
              class="example size"
              :style="{
                height: token.value,
                width: token.value,
            ...
            />
            <div
              v-if="token.category === 'media-query'"
              class="example"
            >
              <div v-if="token.comment">{{ token.comment }}</div>
            </div>
            <div
              v-if="token.category === 'opacity'"
              class="example opacity"
              :style="{
                opacity: token.value,
              }"
            >
              <img :height="cTokens.spaceXxl" src="@/assets/images/google.jpg" alt="google" />
            </div>
